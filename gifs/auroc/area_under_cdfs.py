...
def draw_axes(draw, base_x=250, base_y=180):
    ...
    draw.line((base_x,base_y+150,base_x-150,base_y+150),fill=(0,255,0))
    draw.text((base_x+150, base_y+150), "1-S_A = CDF_A", font=font)
    draw.text((base_x, base_y), "1-S_B = CDF_B", font=font)
...
draw_axes(draw,base_x=250-150*1.0,base_y=100+150*1.0)
draw_neg_curve(draw, alpha_mx=1.0,base_x=250,base_y=100)
draw.text((230, 380), "P(B>A)")
im.show()
